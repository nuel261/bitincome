const appName = 'Bit Income';

const String appbartitle = 'Bit Income';
const String andoidPackageName = 'com.bitincome.wallet';

//change this url to set your URL in app
String webinitialUrl = 'https://bitincomewallet.com/app/';
const String firstTabUrl = 'https://bitincomewallet.com/';

//keep local content of pages of setting screen
const String aboutPageURL = 'https://bitincomewallet.com/';
